...
public partial class ui1 : System.Web.UI.Page
{
    ...
    protected void ilanVer_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(page, page.GetType(), "err_msg", "alert('İlan Başarı İle Yayınlanmıştır.');window.location='tab-panel1.aspx';", true);
        ...
        {
            Response.Write("<script>alert('İlan Kaydı Yapılamamıştır.')</script>");
