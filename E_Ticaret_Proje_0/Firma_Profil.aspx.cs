...
public partial class Firma_Profil : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (FileUpload1.FileContent != null)
        {
            ...
            SqlCommand cmd = new SqlCommand("update resim set baslik=@baslik, resim=@resim where id=" + Session["id"], con);
    ...
    public void resgoster()
    {
        ...
        SqlDataAdapter myAdapter1 = new SqlDataAdapter("SELECT resim FROM resim WHERE id = " + Session["id"], ConfigurationManager.ConnectionStrings["Veritabani"].ConnectionString);
