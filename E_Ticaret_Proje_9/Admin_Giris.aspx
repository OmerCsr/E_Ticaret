<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Giris.aspx.cs" Inherits="Admin_Giris" %>
                            ...
                            <div class="agileits-login">
                                <form action="#" runat="server" method="post">
                                    <asp:TextBox ID="txtkadi" runat="server" type="text" class="email" name="Email" placeholder="Kullanıcı Adı" required=""></asp:TextBox>
                                      <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtkadi" ErrorMessage="Kullanıcı Adı Geçersiz" ForeColor="Red"></asp:RequiredFieldValidator>
                                    <asp:TextBox ID="txtsifre" runat="server" type="password" class="password" name="Password" placeholder="Şifre" required=""></asp:TextBox>
                                    <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtsifre" ErrorMessage="Kullanıcı Şifresi Geçersiz" ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <div class="w3ls-submit">
                                <div class="submit-text" runat="server">
                                    <asp:Button type="submit" Text="Giriş Yap" value="Giriş Yap" runat="server" OnClick="Unnamed_Click" />
