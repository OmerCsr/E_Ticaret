...
public partial class Firma_Tum_Ilanlar : System.Web.UI.Page
{
    ...
    protected void gvTest_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "mesaj")
        {
            ...
            string alıcıdeger1 = HttpUtility.HtmlDecode(GridView1.Rows[index].Cells[2].Text.ToString());
            string iddegeri1 = HttpUtility.HtmlDecode(GridView1.Rows[index].Cells[3].Text.ToString());
            TextBox7.Text = alıcıdeger1;
            TextBox8.Text = iddegeri1;
    ...
    protected void Mesaj_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@ilanId1", TextBox7.Text);
            cmd.Parameters.AddWithValue("@alici1", TextBox8.Text);
            cmd.ExecuteNonQuery();

            Page page = HttpContext.Current.Handler as Page;
            ScriptManager.RegisterStartupScript(page, page.GetType(), "err_msg", "alert('Mesajınız Gönderilmiştir.');window.location='Firma_Tum_Ilanlar.aspx';", true);
