...
public partial class dashboard1 : System.Web.UI.Page
{
    ...
    {
        cnn.Open();
        string kayit = "update kullanicitablo set sifre='"+TxtSifre.Text.Trim()+"',ad='"+TxtAd.Text.Trim()+"',soyad='"+TxtSoyad.Text.Trim()+"',email='"+TxtEmail.Text.Trim()+"',telefon='"+TxtTel.Text.Trim()+"' where id="+Session["id"].ToString() ;
        ...
        ScriptManager.RegisterStartupScript(page, page.GetType(), "err_msg", "alert('Bilgileriniz Güncellenmiştir.');window.location='dashboard1.aspx';", true);
        cnn.Close();
