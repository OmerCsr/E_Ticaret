                ...
                <div class="col-md-12">
                    <form runat="server">
                        ...
                        <asp:Panel ID="Panel1" runat="server">
                            <asp:GridView ID="GridView1"  Width="100%" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" OnRowCommand="gvTest_RowCommand" HorizontalAlign="Center" onrowcreated="GridView1_RowCreated">
