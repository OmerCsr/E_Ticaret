<%@ Page Title="" Language="C#" MasterPageFile="~/Firma.master" AutoEventWireup="true" CodeFile="Firma_Mesajlar.aspx.cs" Inherits="Firma_Mesajlar" %>
    ...
    <div id="page-wrapper" style="background-color:white">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <form runat="server">                 
                      <asp:Button ID="gelen" runat="server" Text="Gelen Mesajlar" OnClick="gelen_Click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White"/>
                            <asp:Button ID="giden" runat="server" Text="Gönderilmiş Mesajlar" OnClick="giden_Click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White" />
                                ...
                                <ItemTemplate>
                                    ...
                                    <table class="table-fill">                    
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            <td width="19%">
                                              <asp:Button ID="Cevap" runat="server" Text="Cevap Yaz" OnClick="Cevap_Click"  BackColor="#C90000" BorderColor="#C90000" ForeColor="White"/>
                                            </td>
                                        </tr>
                                            </tbody>
                                    </table>
