    ...
    <div id="page-wrapper" style="background-color:white">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <form runat="server">
                        <asp:Button ID="Button1" runat="server" Text="Profilim" OnClick="Btn1_click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White"  />
                        <asp:Button ID="Button2" runat="server" Text="Profil Resmi Güncelle" OnClick="Btn2_click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White" />
                        <asp:Button ID="Button4" runat="server" Text="Profil Bilgi Güncelle" OnClick="Button4_Click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White" />
                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="1">
                            <asp:View ID="View1" runat="server">
                                <!--------------------------------------------------->
                                <br />
                                <br />
                                Yüklenecek resmi seçiniz:<br />
               <%--                  <asp:View ID="View4" runat="server">--%>
                                <table class="table-fill" style="color:white;">
                                    <tr style="color: white;">

                                        <td>
                                <asp:FileUpload ID="FileUpload1" runat="server" BorderColor="#C90000" ForeColor="#C90000" />
                                &nbsp;
                               <asp:Button ID="Button3" runat="server" Text="Resmi Güncelle" OnClick="Button1_Click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White" />
                                <br />
                                <br />
                            ...
                            <asp:View ID="View3" runat="server">
                                ...
                                <table class="table-fill">
                                    ...
                                    <tbody class="table-hover">
                                        ...
                                        <tr>
                                            <td class="text-left">
                                                <asp:Button ID="Button5" runat="server" Text="Bilgilerimi Güncelle" OnClick="Button5_Click" BackColor="#C90000" BorderColor="#C90000" ForeColor="White" />
                                            </td>
