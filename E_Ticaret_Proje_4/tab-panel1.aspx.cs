...
public partial class tab_panel1 : System.Web.UI.Page
{
    ...
    private void IlanGoruntule()
    {
        ...
        string sorgu = "Select id as 'İlan Numarası',nereden as Nereden,bulunduguKat as BulunduğuKat,bAsansor as BulunduğuAsansor,nereye,gidecegiKat,gAsansor,evinOdaSayisi,baslangicTarihi,bitisTarihi from ilanlar where kAdi='" + kid+"'";
